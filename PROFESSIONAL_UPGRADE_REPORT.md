...
## إضافة مراحل الاستريشة والتكسير والسلوفان

- تمت إضافة مفاتيح تشغيل مستقلة للمراحل الثلاث في الحاسبة وإنشاء وتعديل الأوردر.
- التكسير والسلوفان يُحسبان ربع/نصف/فرخ لكل ألف أو جزء من ألف، والأسعار قابلة للتعديل من إعدادات السيستم.
- الاستريشة تُحسب تلقائيًا من عرض الشنطة والمنفاخ بعد خصم 1 سم من كل منهما، بجرام وسعر كيلو قابلين للتعديل.
- تمت إضافة مخزن استريشة مستقل بالوزن، مع شراء أو بواقي قص، وسجل حركات وخصم آلي عند مرحلة التصنيع.
- تمت إضافة صفحة فورم مستقلة ببيانات المقاس والسعر والمورد وملف PDF وربط اختياري بالأوردر.
- شراء الفورم يقلل السيولة ويزيد قيمة الأصول بنفس المقدار، ولا يقلل صافي الربح.
- تمت إضافة جهات ومراحل تنفيذ خارجية مستقلة للتكسير والسلوفان في صفحة الصنايعية والتوجيه.

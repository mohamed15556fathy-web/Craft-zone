...
const canManagePurchases = (user.username==='admin'||user.role==='super_admin') || Number(user.perm_purchases || 0) === 1;
const canManageSuppliers = (user.username==='admin'||user.role==='super_admin') || Number(user.perm_suppliers || 0) === 1 || canManagePurchases;

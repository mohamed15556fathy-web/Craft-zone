(function(){
  ...
  async function loadActorUsers(){
    try {
      ...
      canActAsOther = (currentUser.username==='admin'||currentUser.role==='super_admin') || Number(currentUser.perm_assign_any_work_custody || 0) === 1 || Number(data.can_assign_any_work_custody ?? data.can_act_as_other ?? 0) === 1;
    } catch (e) {
      actorUsers = [];
    }
  }
